    ...
    <nav class="navbar navbar-expand-lg col-md-2 d-none d-md-block sidebar p-3" style="background-color: rgba(255, 255, 255, 0.8); ">
      <div class="sidebar-sticky">
        <ul class="navbar-nav flex-column">
          <li class="nav-item">
            <a class="nav-link hvr-float fw-bold e" href="datos.php">Ventas</a>
          </li>
          <li class="nav-item">
...
<div class="row">
    ...
    <select id="personal_ci" name="personal_ci" class="form-select">
    ...
    <select id="unidad_tiempo" name="unidad_tiempo" class="form-select">
