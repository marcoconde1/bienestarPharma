...
<div class="container-fluid " >
  <div class="row" >
    <nav class="navbar navbar-expand-lg col-md-2 d-none d-md-block sidebar p-3" style="background-color: rgba(255, 255, 255, 0.8); ">
      <div class="sidebar-sticky">
        <ul class="navbar-nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link hvr-float fw-bold active" href="eoq_p.php">EOQ con faltantes planeados</a>
          </li>
          <li class="nav-item">
    ...
    <main role="main" class="col-md-10 ml-md-auto px-4 p-3">
        ...
        <?php
        require_once $dir . "/funciones_EOQ_p.php";
                  ...
                  switch ($opcion) {
                      ...
                      case "diario":
                        ...
                        echo "<tr>
                                ...
                                <th>Costo por faltantes</th>
                                <th>Cantidad óptima de pedido</th>
                                <th>Nivel de inventario optimo</th>
                                <th>Cantidad de faltantes maximo</th>
                        ...
                        foreach ($data as $row) {
                            ...
                            echo "<td>" . htmlspecialchars($row['precio_compra']) . "</td>";
                             echo "<td>" . htmlspecialchars($row['precio_faltantes']) . "</td>";
                            echo "<td>" . htmlspecialchars($row['cantidad_optima_pedido']) . "</td>";

                             echo "<td>" . htmlspecialchars($row['nivel_inventario_optimo']) . "</td>";
                            echo "<td>" . htmlspecialchars($row['cantidad_faltantes_maximos']) . "</td>";
                            ...
                            echo "<td>" . htmlspecialchars($row['costo_total']) . "</td>";
                            echo "</tr>";
                        }
